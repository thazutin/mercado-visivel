...
export default function WhatsAppButton() {
  ...
  // Hide when processing screen is active (detected by dark background)
  useEffect(() => {
    const observer = new MutationObserver(() => {
      ...
      if (firstChild) {
        ...
        // Hide on dark backgrounds (processing screen)
        const isDark = bg.includes("22, 22, 24") || bg.includes("rgb(22") || bg.includes("#161618");
        setShow(!isDark);
      }
    });
  ...
  return (
    ...
    >
      ...
      {hover && (
        <span style={{ color: "white", fontSize: 14, fontWeight: 500, fontFamily: "-apple-system, sans-serif", whiteSpace: "nowrap" }}>
          Fale conosco
        </span>
      )}
    </a>
